...
## Project Structure
    ...
    ├── crimson_waterfall_39133  # Django project configurations
...
1. Clone this repo and `cd crimson_waterfall_39133`
...
2. Clone this repo and `cd crimson_waterfall_39133`
